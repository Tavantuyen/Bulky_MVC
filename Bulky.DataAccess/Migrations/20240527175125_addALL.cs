        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PotalCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Conpanies", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Conpanies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Conpanies",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                table: "Conpanies",
                columns: new[] { "Id", "City", "Name", "PhoneNumber", "PotalCode", "State", "StreetAdress" },
                values: new object[,]
                {
                    { 1, "Tech City", "Tech Solution", "0367754060", "6699884400", "TL", "123 Tech St" },
                    { 2, "Vid City", "Vivid Books", "0984126854", "666654", "IL", "999 Vivid St" },
                    { 3, "Main City", "Readers Club", "0383802855", "94654578", "NV", "999 Main St" }
                });
